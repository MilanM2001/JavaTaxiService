...
public class WeeklyStatisticsDisplay extends JFrame {
    ...
    public WeeklyStatisticsDisplay(TaxiService taxiService) {
    ...
    public void saveStatisticsToFile() {
        ...
        taxiService.addStatisticsWeekly(statistics);

        taxiService.saveStatistics(TaxiServiceMain.WeeklyStatistics_File);
    }
