...
public class MonthlyStatisticsDisplay extends JFrame {
    ...
    public MonthlyStatisticsDisplay(TaxiService taxiService) {
    ...
    public void saveStatisticsToFile() {
        ...
        taxiService.addStatisticsMonthly(statistics);

        taxiService.saveStatistics(TaxiServiceMain.MonthlyStatistics_File);
    }
