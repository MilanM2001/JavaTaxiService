package GUI.DispatcherOptions.ForDispatchers;
...
public class DispatchersFormEdit extends JFrame {
    ...
    public DispatchersFormEdit(TaxiService taxiService, Dispatcher dispatcher) {
        ...
        btnOk.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(DispatcherValidation()) {
                    ...
                    DispatchersFormEdit.this.dispose();
                    DispatchersFormEdit.this.setVisible(false);
                }
            }
        });
